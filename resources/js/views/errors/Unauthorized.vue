<template>
    <main>
        ...
        >
            <div class="container">
                <h2 class="text-center heading-primary">Unauthorized</h2>

                <h3 class="text-center">接続権限がありません</h3>

                <div
                    class="text-center [ [ margin-top--48 margin-top-large--80 ] [ margin-bottom--48 margin-bottom-large--140 ] ]"
                >
                    <p
                        class="[ padding-right--16 padding-left--16 ] text-danger"
                    >
                        URLを直接書き込んでアクセスすることはできません。<br />また、一定時間操作しない場合は自動的にログアウトされます。
                    </p>
                    ...
                    <router-link to="/login" class="[ btn btn--accent ]"
