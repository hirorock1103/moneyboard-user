                        ...
                        <article class="padding--16  bg-gray  [ [ margin-left-medium--48  margin-left-large--24 ] [ margin-right-medium--48  margin-right-large--24 ]  [ margin-bottom--48  margin-bottom-large--88 ] ]">
                            <div class="[ padding--24  padding-large--48 ]  bg-white">
                                ...
                                <div class="table-scrollable">
                                    <small>株式会社PPFパートナーズ（以下，「当社」といいます。）は，本アプリ・またはウェブ上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
第1条（個人情報）
...
住所：530-0041 大阪府大阪市北区天神橋1丁目7番17号 イケガミノースハウス4階
社名：株式会社PPFパートナーズ
Eメールアドレス：kobayashi@ambi-tious.com</small>
                                </div>
                            </div>
                        </article>
                </div>
