<template>
    <main>
        ...
        >
            <div class="container">
                <h2 v-show="!verifyErrors" class="text-center heading-primary">
                    メールアドレスの確認
                </h2>
                <p v-show="!verifyErrors" class="text-center">
                    {{ api_message }}
                </p>
                <loading
                ...
                <div
                    ...
                    v-if="verifyErrors"
                >
                    <span v-for="msg in verifyErrors" :key="msg">{{
                        msg
                    }}</span>
                </div>
            </div>
