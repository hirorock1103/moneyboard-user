                            ...
                            >
                                ...
                                <div style="display: flex">
                                    ...
                                    <h5
                                        ...
                                        "
                                    >
                                        8文字以上（半角のアルファベット大文字、小文字、数字の3種類の組み合わせ）<br />入力がない場合はパスワードはそのままです
                                    </h5>
                                </div>
                                <hr />
                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    {{
                                                        getTemps.use_license_count
                                                    }}/{{
                                                        getTemps.available_licenses_total
                                                    }}社
                                                </td>
                                            </tr>
                                            <tr>
...
export default {
    ...
    methods: {
        ...
        async validateItem() {
            ...
            let url =
                process.env.MIX_VUE_APP_API_URL + "com/user/update-validate";
            try {
                this.getTemps = {
                    ...this.getTemps,
