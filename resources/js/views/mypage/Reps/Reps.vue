                        ...
                        <div class="[ padding--24 padding-large--48 ] bg-white">
                                ...
                                <tbody v-if="items.length">
                                    <tr v-for="item in items" :key="item._id">
                                        ...
                                        <th class="text-center">
                                            <button
                                                class="[ btn btn--small btn--accent ] [ margin-bottom--16 margin-bottom-large--0 margin-right-large--16 ]"
                                                v-on:click="
                                                    getItem(
                                                        item.user_code,
                                                        item.use_license_count ??
                                                            0,
                            ...
                            >
                                <div id="content">
                                    ...
                                    >
                                        <p style="color: red">
                                            担当者が保持している企業情報があるため、担当者を削除することができません。
                                        </p>
                                        <p>
                                            ※担当者が保持している企業情報は、「企業一覧から担当者を変更」していただくか、「企業情報を削除」してください。
                                        </p>
                                    </div>
                                    <table class="table table--bordered">
                                        <thead>
        ...
        async fetchItems(page) {
            ...
            try {
                ...
                if (
                    ...
                    this.available_licenses_total =
                        response.data.data.available_licenses_total[user.id];
                    this.resetTemps();
            ...
            if (
                ...
                this.prevRoute.path == "/mypage/company/reps-list_edit_confirm"
            ) {
                ...
                this.$route.query.a == 2 &&
                this.prevRoute.path == "/mypage/company/reps-list_confirm"
            ) {
        ...
        async getItem(user_code, use_license_count, available_licenses_total) {
            ...
            if (response.data.status == "NG") {
                ...
                let items = {
                    ...
                    use_license_count: use_license_count,
                    available_licenses_total: available_licenses_total,
                };
                this.resetTemps();
