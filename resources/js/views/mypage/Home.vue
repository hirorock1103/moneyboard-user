    ...
    <div class="display-flex">
        ...
        <main class="mypage__main">
            ...
            >
                <div class="container">
                    <small
                        class="[ padding-left--16 padding-right-16 padding-medium--0 ] [ [ margin-left-medium--48 margin-left-large--24 ] [ margin-right-medium--48 margin-right-large--24 ] ]"
                    >
                        <span v-if="company && company.use_status == 1"
                            >利用中</span
                        >
                        <span v-else-if="company && company.use_status == 2"
                            >翌月利用停止予定</span
                        >
                        <span
                            v-else-if="company && company.use_status == 98"
                    ...
                    >
                        ...
                        <h5 class="margin-bottom--16">
                            <span
                                class="font-weight-bold display-none-large padding-left--4"
                                >{{
                                    license
                                        ? license.license_available_total
                                        : ""
                                }}</span
                            >
                            <span
                                class="h2 [ display-none display-inline-block-large ] [ padding-left--8 padding-right--4 ]"
                            >
                                {{
                                    license
                            ...
                            >
                            件/{{
                                license ? license.license_total : ""
                            }}件（残件数　{{
                                license ? license.license_available_total : ""
                            }}件）
                        </h5>
                    </div>
                    <article
                    ...
                    >
                        <div class="[ padding--24 padding-large--48 ] bg-white">
                            <h4>
                                <span
                                    class="[ icon solid ] fa-qrcode padding-right--12 text-accent"
                                ></span>
                                アプリダウンロードについて
                            </h4>
                            <hr />
                            <div
                                class="[ display-flex [ flex-column flex-row-large ] ]"
                            >
                                <picture
                                    class="margin-right-large--24 text-center [ padding-bottom--16 padding-bottom-large--0 ]"
                                >
                                    <source
                    ...
                    <article
                        class="padding--16 bg-gray [ [ margin-left-medium--48 margin-left-large--24 ] [ margin-right-medium--48 margin-right-large--24 ] [ margin-bottom--48 margin-bottom-large--100 ] ]"
                    >
                        <div class="[ padding--24 padding-large--48 ] bg-white">
                            <h4>
                                <span
                                    class="[ icon solid ] fa-comment-dots padding-right--12 text-accent"
                                ></span>
                                お知らせ
                            </h4>
                            <hr />
