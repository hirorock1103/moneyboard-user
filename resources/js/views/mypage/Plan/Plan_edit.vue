            ...
            >
                <div class="container">
                    ...
                    <form>
                        ...
                        >
                            ...
                            >
                                <p
                                    ...
                                    "
                                >
                                    ※「スタンダードプラン」への変更や「企業数の追加数」の増加は、"すぐ"に更新されます。
                                </p>
                                <p
                                    style="
                                        margin-bottom: 0;
                                    ...
                                    "
                                >
                                    ※「ライトプラン」への変更や「企業数の追加数」の減少は、"来月"に更新されます。
                                </p>
                                <hr />
                                <div
                                    class="table-scrollable padding-right--8 padding-bottom--24"
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    ...
                                                    <label
                                                        class="form-radio-label margin-bottom--8"
                                                        for="confirm-radio-p"
                                                        >スタンダードプラン<br />(使用できる企業数：120社)</label
                                                    >
                                                </td>
                                            </tr>
                                ...
                                >
                                    <div id="content">
                                        ...
                                        >
                                            <p>プランを変更いたします</p>
                                            <p>
                                                アップグレードの場合は今月、ダウングレードの場合は来月からプランが変更されますが本当によろしいですか？
                                            </p>
                                        </div>
                        ...
                        <div
                            class="text-center [ margin-bottom-medium--0 margin-bottom--24 ]"
                        >
                            <router-link
    ...
    methods: {
        ...
        changeData() {
            if (this.plans.additional_licenses !== "") {
                this.plans.additional_licenses = Number(
                    this.plans.additional_licenses
                );
            }
        ...
        checkIsChanged() {
            ...
            if (this.nowPlans.additional_licenses !== "") {
                check_add_license_count.before = Number(
                    this.nowPlans.additional_licenses
                );
            }
            if (this.plans.additional_licenses !== "") {
                check_add_license_count.after = Number(
                    this.plans.additional_licenses
                );
            }
            this.is_changed =
        ...
        async Store() {
            ...
            if (this.v$.$error) return;
            let url =
                process.env.MIX_VUE_APP_API_URL + "com/contract/update/do";
        ...
        async nextMonthPlans() {
            ...
            try {
                ...
                if (this.nextPlans != "NULL") {
                    ...
                    this.plans.additional_licenses =
                        this.nextPlans.add_license_count;
                    ...
                    this.plans.additional_licenses =
                        this.getContract.add_license_count;
                    ...
                    // TODO::単価が現在固定値なので可変にする場合、検討が必要
                    this.plans.cost_add =
                        1100 * this.getContract.add_license_count;
                }
            } catch (e) {
                console.log(e);
                this.message = e;
