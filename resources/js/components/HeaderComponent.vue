        ...
        <div class="header__inner">
            <div class="header__title">
                <router-link to="/" class="header__logo">
                    ...
                    <span class="header__logo-title [ logo logo__font-main ]"
                        >MoneyBoard</span
                    >
                </router-link>
                <div class="header__subtitle">
                    <span class="[ logo logo__font-sub ]"
                        >Finance × Technology × Laboratory</span
                    >
                </div>
            </div>
            <nav
                class="[ nav nav--inline nav--primary ] [ display-none display-block-large ]"
            >
                <ul>
                    <li v-if="company">
                    ...
                    >
                        <router-link to="/mypage" class="[ btn btn--accent ]"
                            >マイページへ</router-link
                        >
                    </li>
                    <li
            ...
            <nav
                class="menu-button display-none-large"
                v-on:click="MenuBtn = !MenuBtn"
                v-bind:class="{ 'menu-visible': MenuBtn }"
            >
