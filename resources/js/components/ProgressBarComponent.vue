<template>
    ...
    <ul class="progressbar  [ [ margin-top--24  margin-top-large--0 ][ margin-bottom--24  margin-bottom-large--48 ] ]">

        <li
            v-for="step in steps"
            :class="{'progress-item--done':step.done, 'progress-transition':step.current, 'progress-item--current':step.current}"
            :key="step.id">
            <span class="[ icon  solid ]  progress-item__icon"
